...
import { CARD_REVIEWS, DEVICE_TYPES, TESTIMONIALS } from 'src/helpers/constants/constants';
			...
			<section className={styles.section}>
				...
				<section className={styles.section__text__wrapper}>
					...
					<p className={classNames(styles.section__text, inter.className)}>
						Create your online events from any spot fast, easy and richable. Your users
						will see your events and even take part in online activites.
					</p>
